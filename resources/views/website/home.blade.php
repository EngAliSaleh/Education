...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <section class="swiper-slide slide" @if($loop->last  ) active @endif  style="background-image: url('{{url('storage/images/slider/'. $slider->slider_image)}}')">
            <div class="content">
...
<section class="subjects">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img  src="{{ asset('storage/images/subject/'.$subject->subject_image) }}" alt="">
