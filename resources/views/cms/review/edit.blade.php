...
@section('main-title', 'Edite Reviews')
@section('sub-title', 'Edite Reviews')
                            ...
                            <div class="card-body bg-dark">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="reviewr_image" id="reviewr_image"
                                        placeholder=" Enter  Slider Image" value="{{ $reviews->reviewr_image}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="reviewr_description"
